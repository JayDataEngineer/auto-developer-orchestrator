...
python3 plugins/telegram-automation/skills/telegram-automation/scripts/telegram_session.py --bootstrap
...
python3 plugins/telegram-automation/skills/telegram-automation/scripts/telegram_helpers.py list-chats --limit 50
...
# Search messages
python3 plugins/telegram-automation/skills/telegram-automation/scripts/telegram_helpers.py search-messages \
