...
python3 plugins/investment-analysis/skills/investment-analysis/scripts/alt_data.py fetch --url "https://www.sec.gov/..." --cache-key "sec_10k_aapl_2025"

# Cache-wrapped research query
python3 plugins/investment-analysis/skills/investment-analysis/scripts/alt_data.py research --query "AAPL earnings Q2 2026" --cache-key "aapl_news_q2"
```
