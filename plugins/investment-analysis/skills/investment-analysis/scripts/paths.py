...
Auto-discovers all paths relative to this file's location, so scripts work:
  - From the workspace root: `python3 plugins/investment-analysis/skills/investment-analysis/scripts/X.py`
...
# This file lives at plugins/investment-analysis/skills/investment-analysis/scripts/paths.py
...
_PROJECT_FROM_SCRIPT = str(_workspace_root())
