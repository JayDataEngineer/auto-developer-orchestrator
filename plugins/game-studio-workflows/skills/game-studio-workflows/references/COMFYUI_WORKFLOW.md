...
```bash
python3 plugins/game-studio-workflows/skills/game-studio-workflows/scripts/comfyui_client.py health
```
...
```bash
python3 plugins/game-studio-workflows/skills/game-studio-workflows/scripts/comfyui_client.py post-workflow \
...
```bash
python3 plugins/game-studio-workflows/skills/game-studio-workflows/scripts/comfyui_client.py post-prompt \
...
```bash
# Queue depth
python3 plugins/game-studio-workflows/skills/game-studio-workflows/scripts/comfyui_client.py queue
