...
```bash
python3 plugins/game-studio-workflows/skills/game-studio-workflows/scripts/surreal_client.py init-schema
```
...
```bash
TASK_ID=$(python3 plugins/game-studio-workflows/skills/game-studio-workflows/scripts/surreal_client.py start-task \
...
```bash
python3 plugins/game-studio-workflows/skills/game-studio-workflows/scripts/surreal_client.py list-tasks --limit 5 | jq .
```
...
```bash
python3 plugins/game-studio-workflows/skills/game-studio-workflows/scripts/surreal_client.py complete-task \
    --id "$TASK_ID" \
