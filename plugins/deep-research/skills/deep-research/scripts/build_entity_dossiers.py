    ...
    for row in fc_rows:
        ...
        entities[name] = {
            ...
            'notes': (f'Unidentified person whose face appears in {len(photos)} photo(s). '
                      ...
                      f'person via a same_as edge (see plugins/deep-research/skills/deep-research/scripts/link_cluster.py) '
...
def main():
    ...
    if cluster_built:
        ...
        index_lines.append("Proven-same-face/voice sets whose names haven't "
                           ...
                           "`plugins/deep-research/skills/deep-research/scripts/link_cluster.py`; see AGENTS.md Step 2.\n")
