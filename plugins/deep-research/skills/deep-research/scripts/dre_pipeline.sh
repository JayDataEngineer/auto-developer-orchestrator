...
#
# Usage:
#   plugins/deep-research/skills/deep-research/scripts/dre_pipeline.sh data/telegram-dump/ChatExport_2026-03-13
...
SB="plugins/deep-research/skills/deep-research/scripts"
mkdir -p "$RUN_DIR"
