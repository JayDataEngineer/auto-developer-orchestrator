...
`plugins/deep-research/skills/deep-research/scripts/audio_client.py` — wraps the local media MCP HTTP API. Four subcommands:
...
python3 plugins/deep-research/skills/deep-research/scripts/audio_client.py process \
...
```bash
python3 plugins/deep-research/skills/deep-research/scripts/audio_client.py batch \
...
```python
import json
# Use surreal_query / surreal_insert MCP tools for DB operations
