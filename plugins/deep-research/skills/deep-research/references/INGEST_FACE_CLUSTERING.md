...
`plugins/deep-research/skills/deep-research/scripts/face_client.py` — wraps CompreFace REST API. Six subcommands:
...
python3 plugins/deep-research/skills/deep-research/scripts/face_client.py batch-recognize \
...
```bash
python3 plugins/deep-research/skills/deep-research/scripts/face_client.py cluster \
...
```bash
# Register by name
python3 plugins/deep-research/skills/deep-research/scripts/face_client.py add-subject --name "Jane Doe" \
...
python3 plugins/deep-research/skills/deep-research/scripts/face_client.py list-subjects
# Expected: (0 subjects) []

# 2. Add a subject (use any image with a clear face)
python3 plugins/deep-research/skills/deep-research/scripts/face_client.py add-subject --name "TestSubject" --image <face.jpg>

# 3. Recognize the same image → confidence should be 1.0
python3 plugins/deep-research/skills/deep-research/scripts/face_client.py recognize --image <face.jpg> --min-similarity 0.5

# 4. Cluster a batch — verify HDBSCAN runs cleanly
python3 plugins/deep-research/skills/deep-research/scripts/face_client.py cluster --input <batch.json> --output /tmp/c.json
# Expected: "Found N identity clusters from M faces" on stderr

# 5. Cleanup
python3 plugins/deep-research/skills/deep-research/scripts/face_client.py delete-subject --name "TestSubject"
```
