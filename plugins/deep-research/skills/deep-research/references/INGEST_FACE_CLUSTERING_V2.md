...
# Video keyframes — use plugins/deep-research/skills/deep-research/scripts/video_frames.py, NOT raw ffmpeg.
...
for video in data/<export_dir>/<video_subdir>/*.mp4 \
    ...
    python3 plugins/deep-research/skills/deep-research/scripts/video_frames.py extract-scenes \
        --video "$video" \
