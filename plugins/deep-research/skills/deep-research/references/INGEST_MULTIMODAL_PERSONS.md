...
The strategies above are implemented in `plugins/deep-research/skills/deep-research/scripts/resolve_identities.py`. Run it
after `close_graph_gaps.py`:

```bash
python3 plugins/deep-research/skills/deep-research/scripts/resolve_identities.py
```
