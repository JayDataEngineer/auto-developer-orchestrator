...
python3 plugins/deep-research/skills/deep-research/scripts/context_engine.py run \
...
Run `python3 plugins/deep-research/skills/deep-research/scripts/context_engine.py --help` to see all flags.
...
- `plugins/deep-research/skills/deep-research/scripts/context_engine.py` — main orchestrator
- `plugins/deep-research/skills/deep-research/scripts/audio_client.py` — per-file audio processing
- `plugins/deep-research/skills/deep-research/scripts/entity_extract.py` — LLM-based entity extraction
