"""Standalone demo: compile + run the Wan2GP-shaped org with NO harness.
...
it does not import ``pux_harness``, does not touch Docker, and does not need a
real API key (the supervisor model is a tiny scripted stub). A real app swaps
the scripted model for an LLM and supplies its own tools (e.g. a Wan2GP driver).
"""
