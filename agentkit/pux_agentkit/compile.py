...
:mod:`pux_agentkit.loaders`, resolves the specialist roster + skills sources,
...
def _default_project_root() -> Path:
    """``project_root`` default: explicit env override, else the process CWD."""
    return Path(os.environ.get("PUX_PROJECT_ROOT", ".")).resolve()
