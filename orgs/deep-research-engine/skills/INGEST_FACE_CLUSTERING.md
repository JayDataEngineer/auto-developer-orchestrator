...
```bash
python3 sandbox/surreal_client.py insert \
    --table person \
    --record '{"id": "person_0", "label": "Person 0", "face_count": 4, "embedding": [...]}'

python3 sandbox/surreal_client.py insert \
    --table media \
    --record '{"id": "photo_108", "path": "data/.../photo_108.jpg", "type": "image"}'
