          ...
          >
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-sm text-zinc-700 font-bold uppercase tracking-widest mt-1">Authorize Orchestrator for Real-World Ops</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button 
                ...
                className="w-full py-5 bg-primary text-black text-sm font-black uppercase tracking-[0.4em] shadow-lg hover:bg-primary/90 transition-all disabled:opacity-30 disabled:grayscale-0 glow-primary"
              >
